...
const viaje_module_1 = require("./viaje/viaje.module");
...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [usuario_module_1.UsuarioModule, viaje_module_1.ViajeModule, lugar_module_1.LugarModule,
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: 'postgres',
                database: 'museum',
                entities: [usuario_entity_1.UsuarioEntity, viaje_entity_1.ViajeEntity, lugar_entity_1.LugarEntity],
                dropSchema: true,
                synchronize: true,
